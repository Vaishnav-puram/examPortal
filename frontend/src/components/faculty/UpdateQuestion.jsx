...
function UpdateQuestion(){
    ...
    const fetchQuestion=async (queId)=>{
        try{
            const res=await axiosFacultyService.get(`getQuestion/${queId}`,{
                headers: {
    ...
    const handleSubmit=(e)=>{
        ...
        axiosFacultyService.put('/updateQuestion',questionData,{
             headers: {
            'Authorization': `Bearer ${getFacultyToken().token}`,
          }
        }).then((res)=>{
        ...
        navigate('/faculty-dashboard/quizComponentView')
    }
