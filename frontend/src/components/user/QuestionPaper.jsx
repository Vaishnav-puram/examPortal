...
function QuestionPaper() {
    ...
    let [timerCompleted, setTimerCompleted] = useState(false);
    const totalTime = 20;
    const totalTimeInSec = totalTime * 60;
    let [remainingTime, setRemainingTime] = useState(totalTimeInSec);
    useEffect(() => {
        fetchQuestions();
    }, [])
        ...
        <>
            ...
            <div className='gridContainer'>
                ...
                <div className='item-2'>
                    ...
                    <div>
                            <Button className='questionSubmit' variant="outline-success" onClick={handleResults} disabled={timerCompleted}>Submit</Button>
                    </div>
                </div>
            </div>
        </>
